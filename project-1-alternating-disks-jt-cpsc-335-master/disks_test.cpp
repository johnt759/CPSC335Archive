...
int main() {
  ...
  rubric.criterion("sorted_disks still works", 1,
		   [&]() {
         auto temp = sorted_disks(alt_three, 3);
         TEST_EQUAL("sorted_disks::after", temp.after(), alt_three);
         TEST_EQUAL("sorted_disks::swap_count", 3, temp.swap_count());
		   });
  ...
  rubric.criterion("disk_state::is_alternating", 3,
             ...
             TEST_TRUE("is_alternating() after swap", sorted_one.is_alternating());
  ...
  rubric.criterion("left-to-right, other values", 1,
             ...
             //std::cout << "\nn=1 gives " << trial(1) << "\n";
             //std::cout << "n=11 gives " << trial(11) << "\n";
             //std::cout << "n=12 gives " << trial(12) << "\n";
             //std::cout << "n=13 gives " << trial(13) << "\n";
             //std::cout << "n=14 gives " << trial(14) << "\n";
             //std::cout << "n=15 gives " << trial(15) << "\n";
